                                ...
                                <div className="container">
                                    <div className="row justify-content-start">
                                        <div className="col-sm-10 col-lg-8">
                                            ...
                                            <h1 data-aos-duration="1000"   data-aos-offset="300" data-aos="fade-up"   className="display-3 text-white animated slideInDown">The Best <span className='text-danger '>Software Development</span> Platform</h1>
