    ...
    return (
        ...
        <div className="container">
            <div data-aos-duration="1000"   data-aos-offset="300" data-aos="fade-up"   className="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 className="   bg-white text-center text-primary px-3">Gallery</h6>
                <h1 className="mb-5 text-success">Our <span className='text-danger'>Beautiful</span> Moments</h1>
            </div>
            <div className="row g-3">
                <div className="col-lg-7 col-md-6">
                    <div className="row g-3">
                        <div data-aos-duration="1000"   data-aos-offset="300" data-aos="fade-right"  className="col-lg-12 col-md-12 wow zoomIn" data-wow-delay="0.1s">
                        ...
                        <div data-aos-duration="1000"   data-aos-offset="300" data-aos="fade-top"  className="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.3s">
                            <div className="position-relative d-block overflow-hidden" >
                        ...
                        <div data-aos-duration="1000"   data-aos-offset="300" data-aos="fade-top"  className="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.5s">
                            <div className="position-relative d-block overflow-hidden" >
                ...
                <div data-aos-duration="1000"   data-aos-offset="300" data-aos="fade-left"  className="col-lg-5 col-md-6 wow zoomIn" data-wow-delay="0.7s" Style="min-height: 350px;">
