                        ...
                        <div class="card  ">
                            ...
                            <div class="card-body">
                                <form action="">
                                    ...
                                    <button  className='bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500 outline-none w-full my-2 py-3 rounded  px-2 btn btn-outline font-bold'  >Send</button>
                                </form>
                            </div>
                        </div>
